...
ActiveRecord::Base.transaction do
  u1 = User.create!(user_name: "Drumpf")
  u2 = User.create!(user_name: "Gizmo")

  p1 = Poll.create!(title: "Dogz Poll", author_id: u1.id)

  q1 = Question.create!(text: "What Dogz Is Cutest?", poll_id: p1.id)
  ac1 = AnswerChoice.create!(text: "Drumpf", question_id: q1.id)
